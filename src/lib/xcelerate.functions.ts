...
**Make It Pretty In Canva — Copy & Paste This Prompt** — one short sentence telling her exactly what to do: "Go to canva.com, click Create a design, search 'Magic Design', and paste the prompt below." Then a fenced code block (\`\`\`) containing a ready-to-paste Canva Magic Design prompt UNDER 120 WORDS that references the ACTUAL product name and the ACTUAL sections from "What's Inside" above (no generic placeholders). The prompt must specify: the product format and page/slide count (e.g. "a 12-page printable workbook", "a 6-slide Instagram carousel", "a 1-page checklist"), a named color palette tied to her niche (e.g. "warm cream, sage green, and soft terracotta"), typography direction (e.g. "rounded sans-serif headlines, clean readable body text"), the page-by-page section list pulled from "What's Inside", and a tone descriptor (e.g. "warm, encouraging, approachable — not corporate"). After the code block, add ONE sentence: "Then paste your content from the sections above into the matching pages. Done." Do NOT mention ChatGPT, Claude, Gemini, or any other AI tool — Canva only.
